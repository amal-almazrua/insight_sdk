 ...
 ** Example - GyroData
 **
 ** This example shows how to read the built-in gyroscope position.
 **
 ** Simply turn your head from left to right, up and down with the headset.
 **
 ** You will notice the red indicator dot move in accordance with
 ** the movement of your head.
 **
 ** Require OpenGL and GLUT library.
 **
 ****************************************************************************/
