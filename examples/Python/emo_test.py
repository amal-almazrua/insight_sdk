# python version >= 2.5
# to run this example , you must move file "InsightEDK.dll" and "edk_utils.dll"
# in the same folder that contains this file
...
print os.path.exists('.\\InsightEDK.dll')
print os.path.abspath("InsightEDK.dll")

#libEDK = ctypes.WinDLL("InsightEDK.dll")
