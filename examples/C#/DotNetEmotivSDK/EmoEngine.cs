...
namespace Emotiv
{
    ...
    public class Profile
    {
        ...
        public Profile()
        {
            hProfile = EdkDll.IEE_ProfileEventCreate();
            EdkDll.IEE_GetBaseProfile(hProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
        ~Profile()
        {
            if (hProfile != null)
            {
                EdkDll.IEE_EmoEngineEventFree(hProfile);
            }
        }
        ...
        public Byte[] GetBytes()
        {
            ...
            EmoEngine.errorHandler(EdkDll.IEE_GetUserProfileSize(hProfile, out profileSizeOut));
            Byte[] profileBytes = new Byte[profileSizeOut];
            EmoEngine.errorHandler(EdkDll.IEE_GetUserProfileBytes(hProfile, profileBytes, profileSizeOut));
            return profileBytes;
        }
    ...
    public class EmoEngine
    {
        ...
        public void SetUserProfile(UInt32 userId, Profile profile)
        {
            ...
            errorHandler(EdkDll.IEE_SetUserProfile(userId, profileBytes, (UInt32)profileBytes.Length));
        }

        /// <summary>
        /// Fills in the event referred to by hEvent with an IEE_ProfileEvent event that contains the profile data for the specified user.
        /// </summary>
        /// <param name="userId">user ID</param>
        ...
        public Profile GetUserProfile(UInt32 userId)
        {
            ...
            errorHandler(EdkDll.IEE_GetUserProfile(userId, tempProfile.GetHandle()));
            return tempProfile;
        }
        ...
        {
            errorHandler(EdkDll.IEE_LoadUserProfile(userID, szInputFilename));
        }
        ...
        public void SaveUserProfile(UInt32 userID, String szOutputFilename)
        {
            errorHandler(EdkDll.IEE_SaveUserProfile(userID, szOutputFilename));
        }
        ...
        /// <param name="userId">user ID</param>
        /// <param name="enable">If true, then enables data acquisition. If false, then disables data acquisition.</param>
        public void MotionDataAcquisitionEnable(UInt32 userId, bool enable)
        {
            errorHandler(EdkDll.IEE_MotionDataAcquisitionEnable(userId, enable));
        }
        ...
        /// receives whether data acquisition is enabled
        /// </returns>
        public Boolean IsMotionDataAcquisitionEnabled(UInt32 userId)
        {
            Boolean result = false;

            errorHandler(EdkDll.IEE_MotionDataAcquisitionIsEnabled(userId, out result));
