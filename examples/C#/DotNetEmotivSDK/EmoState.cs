...
namespace Emotiv
{
    ...
    public class EmoState : ICloneable
    {
        ...
        {
            return EdkDll.IS_PerformanceMetricGetExcitementLongTermScore(hEmoState);
        }
        /// <summary>
        ...
        {
            return EdkDll.IS_PerformanceMetricGetInstantaneousExcitementScore(hEmoState);
        }
        /// <summary>
        ...
        /// <returns>detection state (false: Not Active, true: Active)</returns>
        public Boolean PerformanceMetricIsActive(EdkDll.IEE_PerformanceMetricAlgo_t type)
        {
            return EdkDll.IS_PerformanceMetricIsActive(hEmoState, type);
        }
        /// <summary>
        ...
        {
            return EdkDll.IS_PerformanceMetricGetRelaxationScore(hEmoState);
        }
        /// <summary>
        ...
        {
            return EdkDll.IS_PerformanceMetricGetStressScore(hEmoState);
        }
        /// <summary>
        ...
        {
            return EdkDll.IS_PerformanceMetricGetEngagementBoredomScore(hEmoState);
        }
        /// <summary>
        ...
        {
            return EdkDll.IS_PerformanceMetricGetInterestScore(hEmoState);
        }
        /// <summary>
        ...
        {
            return EdkDll.IS_PerformanceMetricGetFocusScore(hEmoState);
        }
        /// <summary>
        ...
        {
            return EdkDll.IS_PerformanceMetricEqual(GetHandle(), state.GetHandle());
        }
        /// <summary>
      ...
      /// <summary>
        ...
        {
            EdkDll.IS_PerformanceMetricGetInstantaneousExcitementModelParams(hEmoState, out rawScore, out minScale, out maxScale);
        }
        /// <summary>
        ...
        {
            EdkDll.IS_PerformanceMetricGetRelaxationModelParams(hEmoState, out rawScore, out minScale, out maxScale);
        }
        /// <summary>
        ...
        {
            EdkDll.IS_PerformanceMetricGetEngagementBoredomModelParams(hEmoState, out rawScore, out minScale, out maxScale);
        }
        /// <summary>
        ...
        {
            EdkDll.IS_PerformanceMetricGetStressModelParams(hEmoState, out rawScore, out minScale, out maxScale);
        }
        /// <summary>
        ...
        {
            EdkDll.IS_PerformanceMetricGetInterestModelParams(hEmoState, out rawScore, out minScale, out maxScale);
        }
        /// <summary>
        ...
        {
            EdkDll.IS_PerformanceMetricGetFocusModelParams(hEmoState, out rawScore, out minScale, out maxScale);
        }
    }
}
