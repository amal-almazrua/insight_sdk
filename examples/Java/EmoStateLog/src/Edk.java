...
public interface Edk extends Library {
	...
	/*!	
		...
		\sa edkErrorCode.h
	*/
	int IEE_EngineLocalConnect(String strFilePath);	
	 ...
	 * IEE_DataCreate() \return EDK_ERROR_CODE - EDK_ERROR_CODEEDK_OK if
	 * successful
	 */
	...
	/*
	 * ! \param hData - a handle returned by IEE_DataCreate() \param channel -
	...
	/*
	 * ! \param hData - a handle returned by IEE_DataCreate() \param nSampleOut
