...
public interface EmoState extends Library {
	...
	// ! Query whether the signal is too noisy for PerformanceMetric detection
	// to be active
	/*
	 * ! \param state - Pointer \param type - PerformanceMetric detection type
	 * 
	 * \return detection state (0: Not Active, 1: Active)
	 * 
	 * \sa int
    ...
    */
	 ...
	 * 
	 * \sa IS_FacialExpressionEqual, IS_MentalCommandEqual, IS_EmoEngineEqual,
	 * IS_Equal
	 */
