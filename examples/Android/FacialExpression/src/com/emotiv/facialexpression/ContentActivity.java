...
import com.emotiv.insight.IEdk.IEE_FacialExpressionEvent_t;
import com.emotiv.insight.IEdk.IEE_FacialExpressionThreshold_t;
import com.emotiv.insight.IEdk.IEE_FacialExpressionTrainingControl_t;
...
public class ContentActivity extends Activity implements EngineInterface{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spinnerSensitive.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				case 0:
					// neutral
					IEdk.IEE_FacialExpressionSetThreshold(userId,IEE_FacialExpressionAlgo_t.FE_NEUTRAL.ToInt(), IEE_FacialExpressionThreshold_t.FE_SENSITIVITY.toInt(), arg2*100);
					break;
				case 1:
					//smile
					IEdk.IEE_FacialExpressionSetThreshold(userId,IEE_FacialExpressionAlgo_t.FE_SMILE.ToInt(), IEE_FacialExpressionThreshold_t.FE_SENSITIVITY.toInt(), arg2*100);
					break;
				case 2:
					//clench
					IEdk.IEE_FacialExpressionSetThreshold(userId,IEE_FacialExpressionAlgo_t.FE_CLENCH.ToInt(), IEE_FacialExpressionThreshold_t.FE_SENSITIVITY.toInt(), arg2*100);
					break;
				case 3:
					//frown
					IEdk.IEE_FacialExpressionSetThreshold(userId,IEE_FacialExpressionAlgo_t.FE_FROWN.ToInt(), IEE_FacialExpressionThreshold_t.FE_SENSITIVITY.toInt(), arg2*100);
					break;	
				case 4:
					//suprise
					IEdk.IEE_FacialExpressionSetThreshold(userId,IEE_FacialExpressionAlgo_t.FE_SURPRISE.ToInt(), IEE_FacialExpressionThreshold_t.FE_SENSITIVITY.toInt(), arg2*100);
					break;		
				default:
					break;
				}
	  ...
	  public void setListData()
	    {
	        ...
	        // For further inhancement we can take data by webservice / json / xml;
	            ...
	            ProfileManager.shareInstance().loadProfile(userId);
	...
	public void trainCompleted() {
		// TODO Auto-generated method stub
		ProfileManager.shareInstance().saveProfile(userId);
	...
	/// handler
	  public Handler mHandlerUpdateUI = new Handler() {
	       public void handleMessage(Message msg) {
			...
			case 0:
				count ++;
				int trainningTime=(int)IEdk.IEE_FacialExpressionGetTrainingTime(userId)[1]/1000;
