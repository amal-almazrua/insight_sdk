...
IEE_MotionDataChannel_t targetChannelList_Insight[] = {
    IED_COUNTER_MEMS,
    IED_GYROSCOPEX, IED_GYROSCOPEY, IED_GYROSCOPEZ, IED_ACCX,
    IED_ACCY, IED_ACCZ, IED_MAGX,IED_MAGY,IED_MAGZ,IED_MOTIONTIMESTAMP
};


const char *headerStr_EPOC = "COUNTER,AF3,F7,F3, FC5, T7, P7, O1, O2,P8, T8, FC6, F4,F8, AF4,GYROX, GYROY, TIMESTAMP, FUNC_ID, FUNC_VALUE,MARKER, SYNC_SIGNAL,";
